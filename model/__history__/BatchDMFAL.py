...
#         start
        ...
        print(' - compute the variance takes', time.time()-start_t)
        ...
        elapse_t1 = time.time() - start_t
        print(' - compose matrices takes', elapse_t1)
    ...
    def eval_batch_mutual_info(self, X_batch, m_batch):
        ...
        print(m_batch, 'takes time', end_time)
