...
python main.py evaluation -heuristic 'BoundBatchDMFAL' -domain 'Navier' -M 2  -trial 1 \
...
python main.py evaluation -heuristic 'BoundBatchDMFAL' -domain 'Navier' -M 2  -trial 2 \
    -input_dim_list [5,5] -output_dim_list [54621,121296] -base_dim_list [32,32] \
    -hlayers_w [40,40] -hlayers_d [2,2] \
    -activation 'tanh' -penalty [1,3] \
    -print_freq 10 -max_epochs=$MAX_EPOCHS -learning_rate 1e-3 -reg_strength 1.0 \
...
# python main.py evaluation -heuristic 'BoundBatchDMFAL' -domain 'Navier' -M 2  -trial 3 \
#     -input_dim_list [5,5] -output_dim_list [54621,121296] -base_dim_list [32,32] \
#     -hlayers_w [40,40] -hlayers_d [2,2] \
#     -activation 'tanh' -penalty [1,3] \
#     -print_freq 10 -max_epochs=$MAX_EPOCHS -learning_rate 1e-3 -reg_strength 1.0 \
